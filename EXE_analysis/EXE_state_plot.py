...
def initialize():
    parser = argparse.ArgumentParser(
        description='This code analyzes the dhdl file generated by expanded \
...
class StateTimeAnalysis(EXEAnalysis):
    ...
    def __init__(self, logfile):
        """
        Sets up the properties of the instance of StateTimeAnalysis
        """
    ...
    def plot_data(self, x, y, type, title, png_name, trnctd=False):
        ...
        y : np.array or list
            The y data.
        type : str
            The type of data analysis tha the data belongs to.
        title : str
            The title of the plot
        png_name : str
            The name of the png file to be saved
        trnctd : bool
            If the data should be truncated in the plot of state-time data.
    ...
    def truncate_dhdl(self, dhdl):
        """
        Reads in a dhdl file, truncate the part that the weights are still equilibrating and save as a new file
        
        Parameters
        ----------
        dhdl : str
            The name of the dhdl file to be truncated
